 ...
 * {@link DiaFragment2.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link DiaFragment2#newInstance} factory method to
...
public class DiaFragment2 extends Fragment {
    ...
    public static DiaFragment2 newInstance(int position) {
        DiaFragment2 fragment = new DiaFragment2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switch (mPosition) {
            ...
            case 1:
                ...
                case 2:
                textViewFragmento.setText("AjS");
                break;
            case 3:
                textViewFragmento.setText("PIjjjjAS");
                break;
