...
public class ProveedorDeContenido extends ContentProvider {
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        void inicializarDatos(SQLiteDatabase db){
            ...
            db.execSQL("INSERT INTO " + LIBRO_TABLE_NAME + " (" +  Contrato.Libro._ID + "," + Contrato.Libro.TITULO + "," + Contrato.Libro.EDITORIAL + "," + Contrato.Libro.PAGINAS + ") " +
                    "VALUES (1,'Suerte de haberte conocido','Laista','283')");
            db.execSQL("INSERT INTO " + LIBRO_TABLE_NAME + " (" +  Contrato.Libro._ID + "," + Contrato.Libro.TITULO + "," + Contrato.Libro.EDITORIAL + "," + Contrato.Libro.PAGINAS + ") " +
                    "VALUES (2,'Cuestionar la metafisica','McGraw','120')");
            db.execSQL("INSERT INTO " + LIBRO_TABLE_NAME + " (" +  Contrato.Libro._ID + "," + Contrato.Libro.TITULO + "," + Contrato.Libro.EDITORIAL + "," + Contrato.Libro.PAGINAS + ") " +
                    "VALUES (3,'La vida del soltero','Foelfa','58')");
            db.execSQL("INSERT INTO " + LIBRO_TABLE_NAME + " (" +  Contrato.Libro._ID + "," + Contrato.Libro.TITULO + "," + Contrato.Libro.EDITORIAL + "," + Contrato.Libro.PAGINAS + ") " +
                    "VALUES (4,'Vistas en el paraiso','Dentel','253')");
        }
