...
public class LibroModificarActivity extends AppCompatActivity {
    ...
    EditText editTextLibroEditorial;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextLibroEditorial = (EditText) findViewById(R.id.editTextLibroEditorial);
        ...
        editTextLibroEditorial.setText(libro.getEditorial());
    ...
    //metodo para guardar los datos en la base de datos
        ...
        EditText editTextLibroEditorial = (EditText) findViewById(R.id.editTextLibroEditorial);
        ...
        editTextLibroEditorial.setError(null);
        editTextLibroPaginas.setError(null);

        //Capturamos los datos

        String titulo = String.valueOf((editTextLibroTitulo.getText()));
        String editorial = String.valueOf((editTextLibroEditorial.getText()));
        ...
        if (TextUtils.isEmpty(titulo)){
            ...
            if (TextUtils.isEmpty(editorial)){
                editTextLibroEditorial.setError(getString(R.string.campo_requerido));
                editTextLibroEditorial.requestFocus();
                return;
        }
        ...
        Libro libro = new Libro(libroId, titulo, editorial, paginas);
